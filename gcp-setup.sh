...
DB_URL="jdbc:postgresql:///${SQL_DB}?cloudSqlInstance=${INSTANCE_CONNECTION}&socketFactory=com.google.cloud.sql.postgres.SocketFactory&ipTypes=PRIVATE,PUBLIC"
...
echo "    --project=${PROJECT_ID} \\"
echo "    --substitutions=_CLOUD_SQL_INSTANCE=${INSTANCE_CONNECTION},_DB_URL=${DB_URL},_DB_PASSWORD=${SQL_PASSWORD}"
echo ""
